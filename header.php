...
<body <?php body_class(); ?>>
    ...
    <div id="page" class="site">
        <a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e('Skip to content', 'leonardo-mix-vite'); ?></a>
            ...
            <nav class="flex justify-between bg-gray-900">
                <div class="container mx-auto px-5 xl:px-12 py-6 flex w-full items-center">
                    <div class="site-branding">
                        ...
                        $leonardo_mix_vite_description = get_bloginfo('description', 'display');
                        if ($leonardo_mix_vite_description || is_customize_preview()) :
                        ?>
                            <p class="site-description text-sm font-bold text-amber-400"><?php echo $leonardo_mix_vite_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
                                                                                            ?></p>
                        <?php endif; ?>
                    </div><!-- .site-branding -->
                    <!-- Nav Links -->
                    <nav id="site-navigation" class="main-navigation flex items-center justify-center text-slate-200 px-4 mx-auto my-0 font-semibold font-heading space-x-12 list-none">
                        <button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e('Primary Menu', 'leonardo-mix-vite'); ?></button>
                        <?php
                            wp_nav_menu(
                                array(
