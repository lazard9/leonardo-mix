...
<footer id="colophon" class="site-footer text-gray-600 body-font bg-gray-700">
    <div class="container px-5 xl:px-12 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    ...
    <div class="bg-gray-900">
        <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p class="text-white text-sm text-center sm:text-left site-info">
                <a href="<?php echo esc_url(__('https://wordpress.org/', 'leonardo-mix-vite')); ?>">
                    <?php
                    /* translators: %s: CMS name, i.e. WordPress. */
                    printf(esc_html__('Proudly powered by %s', 'leonardo-mix-vite'), 'WordPress');
                    ?>
                </a>
                <span class="sep"> | </span>
                <?php
                /* translators: 1: Theme name, 2: Theme author. */
                printf(esc_html__('Theme: %1$s by %2$s.', 'leonardo-mix-vite'), 'leonardo-mix-vite', '<a href="https://profiles.wordpress.org/lazarus9/">Lazar</a>');
                ?>
            </p><!-- .site-info -->
